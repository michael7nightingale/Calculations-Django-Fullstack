...
class Parameters:
    ...
    def get_constants(self, params_common: dict, args: str):
        constants = dict()
    ...
    # @lru_cache(maxsize=64)
    def get_functions(self, params_common: dict, args: str):
        functions = dict()
        for i in params_common:
            if i in args:
    ...
    def load_data(self) -> None:
        try:
            with open(str(BASE_DIR) + self.params_path + self.science_name + '_params.json') as file:
